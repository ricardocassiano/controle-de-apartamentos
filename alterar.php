...
<html lang="pt-br">
  <head>
	...
	<!-- Biblioteca jQueryMask, para máscara de campos de entrada-->
		...
		<div class="col-sm-8 text-left">
			...
			<?php
				if (isset ($_POST['num']))
				{
					...
					$stmt = $con->prepare("UPDATE apartamentos SET numero = ?, bloco = ?, dependencias = ?, aquisicao = ?, status = ?, preco = ? WHERE cod = ?");
					...
					$stmt->bindParam(7,$id);
					if ($stmt->execute())
						echo "<center>Registro alterado com sucesso!</center><br>";
					else
						echo "<center>Não foi possível alterar o registro!</center><br>";
