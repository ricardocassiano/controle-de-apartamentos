	...
	<div class="container-fluid text-center">
	  <div class="row content">
		...
		<div class="col-sm-8 text-left">
			<h1>Apartamento <small> - Digite o número do Apto que deseja encontrar </small></h1>
			...
			<?php
				if (isset ($_POST['num']))
				{
					...
					$_SESSION['dependencias'] = $linha->dependencias;
					$_SESSION['aquisicao'] = $linha->aquisicao;
					$_SESSION['status'] = $linha->status;
					$_SESSION['preco'] = $linha->preco;
				}
			?>
			<br>
			<form class="form-horizontal" action="gerarPDF.php" method="post">
			<div class="form-group"> 
				<div class="col-sm-offset-2 col-sm-10">
				  <button type="submit" class="btn btn-default" href="gerarPDF.php">Gerar PDF</button>
				</div>
			  </div>
